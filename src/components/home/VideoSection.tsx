      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-4">
            {language === 'pt' 
              ? 'Nascemos do desejo de iluminar quem sempre esteve atrás do brilho: aderecistas, costureiras, carnavalescos, músicos, diretores de harmonia, mestres-sala, porta-bandeiras e tantos outros profissionais do carnaval.' 
              : 'We were born from the desire to spotlight those who have always been behind the shine: costume designers, seamstresses, carnival designers, musicians, harmony directors, masters of ceremonies, flag bearers and many other carnival professionals.'}
          </p>
          <p className="text-sm md:text-base text-muted-foreground italic">
            {language === 'pt' 
              ? 'Este documentário celebra nossa trajetória, os encontros que construímos e a força da cadeia produtiva do carnaval. Assista e conheça algumas das histórias, rostos e bastidores que nos ajudam a registrar e valorizar.' 
              : 'This documentary celebrates our journey, the connections we built and the strength of the carnival production chain.'}
          </p>
        </div>
